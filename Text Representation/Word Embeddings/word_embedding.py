...
# küçük harfe çevirip tokenize etme işlemini gerçekleştirelim.
...
plot_word_embedding(word2_vec_model , "Word2Vec Model")
plot_word_embedding(fasttext_model , "FastText Model")